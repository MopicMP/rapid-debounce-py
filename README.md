...
> Rapid debounce function calls (thread-safe)

[![PyPI version](https://badge.fury.io/py/rapid-debounce-py.svg)](https://pypi.org/project/rapid-debounce-py/)
...
from rapid_debounce_py import batch
